...
def calculate_demographic_data(print_data=True):
    ...
    # Calculate the number of people earning >50K per country
    high_salary_counts = df[df['salary'] == '>50K']['native-country'].value_counts()

    # Calculate the total number of respondents per country
    total_country_counts = df['native-country'].value_counts()

    # Calculate the percentage of people earning >50K per country
    high_salary_percentage = (high_salary_counts / total_country_counts * 100).sort_values(ascending=False)
